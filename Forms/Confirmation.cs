...
namespace WinFormApp.Forms
{
    public partial class Confirmation : Form
    {
        ...
        {
            UIStyle.ModernUIButton(btnOK, Color.FromArgb(46, 204, 113), Color.FromArgb(22, 160, 133));
            UIStyle.ModernUIButton(btnCancel, Color.FromArgb(231, 76, 60), Color.FromArgb(176, 52, 40));
        }
